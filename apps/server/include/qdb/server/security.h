...
public:
    ...
    auto Update(const std::vector<std::uint8_t>& data) -> void;
    auto Digest() -> std::vector<std::uint8_t>;

    static auto Hash(const std::vector<std::uint8_t>& data) -> std::vector<std::uint8_t>;
