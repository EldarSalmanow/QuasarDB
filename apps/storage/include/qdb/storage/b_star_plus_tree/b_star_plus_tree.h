...
public:
    ...
    std::optional<ValueType> search(const KeyType& key) const {
        if (Node<KeyType, ValueType>::DEBUG) std::cout << "BTree::search(key=" << key << ")" << std::endl;
    ...
    void insert(const KeyType& key, const ValueType& value) {
        if (Node<KeyType, ValueType>::DEBUG) std::cout << "BTree::insert(key=" << key << ", value=" << value << ")" << std::endl;
        if (!root) {
    ...
    bool remove(const KeyType& key) {
        if (Node<KeyType, ValueType>::DEBUG) std::cout << "BTree::remove(key=" << key << ")" << std::endl;
        std::stack<std::pair<InternalNode<KeyType, ValueType>*, int>> parentStack;
        auto leaf = findLeaf(key, parentStack);
    ...
    std::vector<std::pair<KeyType, ValueType>> rangeSearch(const KeyType& low, const KeyType& high) const {
        if (Node<KeyType, ValueType>::DEBUG) std::cout << "BTree::rangeSearch(low=" << low << ", high=" << high << ")" << std::endl;
...
private:
    ...
    void clear(Node<KeyType, ValueType>* node) {
        if (Node<KeyType, ValueType>::DEBUG) std::cout << "BTree::clear(node=" << node << ")" << std::endl;
        if (!node) return;
        if (!node->isLeaf()) {
    ...
    LeafNode<KeyType, ValueType>* findLeaf(const KeyType& key,
            std::stack<std::pair<InternalNode<KeyType, ValueType>*, int>>& parentStack) const {
        if (Node<KeyType, ValueType>::DEBUG) std::cout << "BTree::findLeaf(key=" << key << ")" << std::endl;
    ...
    void handleLeafOverflow(LeafNode<KeyType, ValueType>* leaf,
                            std::stack<std::pair<InternalNode<KeyType, ValueType>*, int>>& parentStack) {
        if (Node<KeyType, ValueType>::DEBUG) std::cout << "BTree::handleLeafOverflow(leaf=" << leaf << ")" << std::endl;
    ...
    void splitLeaf1to2(LeafNode<KeyType, ValueType>* node) {
        if (Node<KeyType, ValueType>::DEBUG) std::cout << "BTree::splitLeaf1to2(node=" << node << ")" << std::endl;
    ...
    void redistributeLeaves2to2(LeafNode<KeyType, ValueType>* left,
                            LeafNode<KeyType, ValueType>* right,
                            InternalNode<KeyType, ValueType>* parent,
                            int leftIndex) {
        if (Node<KeyType, ValueType>::DEBUG) std::cout << "BTree::redistributeLeaves2to2(left=" << left << ", right=" << right << ", parent=" << parent << ", leftInx=" << leftIndex << ")" << std::endl;
    ...
    void redistributeLeaves3to3(LeafNode<KeyType, ValueType>* left,
                                LeafNode<KeyType, ValueType>* middle,
                                LeafNode<KeyType, ValueType>* right,
                                InternalNode<KeyType, ValueType>* parent,
                                int leftIndex) {
        if (Node<KeyType, ValueType>::DEBUG) std::cout << "BTree::redistributeLeaves3to3(left=" << left << ", middle=" << middle << ", right=" << right << ", parent=" << parent << ", leftInx=" << leftIndex << ")" << std::endl;
    ...
    void splitLeaves2to3(LeafNode<KeyType, ValueType>* middle,
                         std::stack<std::pair<InternalNode<KeyType, ValueType>*, int>>& parentStack) {
        if (Node<KeyType, ValueType>::DEBUG) std::cout << "BTree::splitLeaves2to3(middle=" << middle << ")" << std::endl;
    ...
    void handleInternalOverflow(InternalNode<KeyType, ValueType>* node,
                                std::stack<std::pair<InternalNode<KeyType, ValueType>*, int>>& parentStack) {
        if (Node<KeyType, ValueType>::DEBUG) std::cout << "BTree::handleInternalOverflow(node=" << node << ")" << std::endl;
    ...
    void redistributeInternal2to2(InternalNode<KeyType, ValueType>* left, 
                                  InternalNode<KeyType, ValueType>* right, 
                                  InternalNode<KeyType, ValueType>* parent, 
                                  int leftIdxInParent) {
        if (Node<KeyType, ValueType>::DEBUG) std::cout << "BTree::redistributeInternal2to2(left=" << left << ", right=" << right << ", parent=" << parent << ", leftIdxInParent=" << leftIdxInParent << ")" << std::endl;
    ...
    void redistributeInternal3to3(InternalNode<KeyType, ValueType>* left,
                                  InternalNode<KeyType, ValueType>* middle,
                                  InternalNode<KeyType, ValueType>* right,
                                  InternalNode<KeyType, ValueType>* parent, 
                                  int leftIdxInParent) {
        if (Node<KeyType, ValueType>::DEBUG) std::cout << "BTree::redistributeInternal3to3(left=" << left << ", middle=" << middle << ", right=" << right << ", parent=" << parent << ", leftIdxInParent=" << leftIdxInParent << ")" << std::endl;
    ...
    void splitInternal2to3(InternalNode<KeyType, ValueType>* node,
                           std::stack<std::pair<InternalNode<KeyType, ValueType>*, int>>& parentStack) {
        if (Node<KeyType, ValueType>::DEBUG) std::cout << "BTree::splitInternal2to3(node=" << node << ")" << std::endl;
    ...
    void splitInternal1to2(InternalNode<KeyType, ValueType>* node) {
        if (Node<KeyType, ValueType>::DEBUG) std::cout << "BTree::splitInternal1to2(node=" << node << ")" << std::endl;
    ...
    void handleLeafUnderflow(LeafNode<KeyType, ValueType>* leaf,
                             std::stack<std::pair<InternalNode<KeyType, ValueType>*, int>>& parentStack) {
        if (Node<KeyType, ValueType>::DEBUG) std::cout << "BTree::handleLeafUnderflow(leaf=" << leaf << ")" << std::endl;
        ...
        if (index == parent->children.size() - 1 && parent->children[parent->children.size() - 3]->canLend()) {
            redistributeLeaves3to3(static_cast<LeafNode<KeyType, ValueType>*>(parent->children[index - 2]),
                static_cast<LeafNode<KeyType, ValueType>*>(parent->children[index - 1]),
                leaf, parent, index - 2);
            return;
        }
    ...
    void mergeLeaves3to2(LeafNode<KeyType, ValueType>* leaf,
                         std::stack<std::pair<InternalNode<KeyType, ValueType>*, int>>& parentStack) {
        if (Node<KeyType, ValueType>::DEBUG) std::cout << "BTree::mergeLeaves3to2(leaf=" << leaf << ")" << std::endl;
    ...
    void mergeLeaves2to1(LeafNode<KeyType, ValueType>* leaf, 
                         std::stack<std::pair<InternalNode<KeyType, ValueType>*, int>>& parentStack) {
        if (Node<KeyType, ValueType>::DEBUG) std::cout << "BTree::mergeLeaves2to1(leaf=" << leaf << ")" << std::endl;
    ...
    void handleInternalUnderflow(InternalNode<KeyType, ValueType>* node,
                                 std::stack<std::pair<InternalNode<KeyType, ValueType>*, int>>& parentStack) {
        if (Node<KeyType, ValueType>::DEBUG) std::cout << "BTree::handleInternalUnderflow(node=" << node << ")" << std::endl;
    ...
    void mergeInternal2to1(InternalNode<KeyType, ValueType>* node) {
        if (Node<KeyType, ValueType>::DEBUG) std::cout << "BTree::mergeInternal2to1(node=" << node << ")" << std::endl;
    ...
    void mergeInternal3to2(InternalNode<KeyType, ValueType>* node,
                           std::stack<std::pair<InternalNode<KeyType, ValueType>*, int>>& parentStack) {
        if (Node<KeyType, ValueType>::DEBUG) std::cout << "BTree::mergeInternal3to2(node=" << node << ")" << std::endl;
...
private:
    ...
    std::tuple<KeyType, KeyType, bool> check_node_integrity(Node<KeyType, ValueType>* node) const {
        if (!node) return {KeyType(), KeyType(), false};
        bool isRootChild = (node != root) && (std::find(static_cast<InternalNode<KeyType, ValueType>*>(root)->children.begin(), static_cast<InternalNode<KeyType, ValueType>*>(root)->children.end(), node) != static_cast<InternalNode<KeyType, ValueType>*>(root)->children.end());
        ...
        for (size_t i = 0; i + 1 < node->size(); ++i) {
            if (node->keys[i] >= node->keys[i + 1]) result = false;
        }
        if (node->isLeaf()) {
            auto leaf = static_cast<LeafNode<KeyType, ValueType>*>(node);
            if (leaf->keys.empty()) return {KeyType(), KeyType(), false};
            return {leaf->keys.front(), leaf->keys.back(), result};
        }
        auto in = static_cast<InternalNode<KeyType, ValueType>*>(node);
        if (in->children.empty()) return {KeyType(), KeyType(), false};
        ...
        for (size_t i = 0; i < in->children.size(); ++i) {
            ...
            result &= childValid;
            if (i > 0) {
                if (in->keys[i - 1] > childMin) result = false;
            }
            if (i < in->size()) {
                if (childMax >= in->keys[i]) result = false;
            }
            if (i == 0) globalMin = childMin;
            if (i == in->children.size() - 1) globalMax = childMax;
        }
